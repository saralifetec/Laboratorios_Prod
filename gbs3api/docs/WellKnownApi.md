# gbs3api.WellKnownApi

All URIs are relative to */GBS*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_jwks**](WellKnownApi.md#get_jwks) | **GET** /webservice/.well-known/jwks.json | Gets the JWT public key(s) in JWK Set format
...
with gbs3api.ApiClient(configuration) as api_client:
    ...
    api_instance = gbs3api.WellKnownApi(api_client)
